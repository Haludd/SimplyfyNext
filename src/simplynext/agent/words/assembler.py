...
_INFLECTIONS = {
    # Third-person-singular agreement only: same verb, same tense, same meaning,
    # just the ending English requires for a singular subject (WANT was the
    # original reviewed case; the rest of this repo's action-verb vocabulary
    # follows the identical regular pattern).
    "WANT": {"wants"},
    "NEED": {"needs"},
    "LIKE": {"likes"},
    "HELP": {"helps"},
